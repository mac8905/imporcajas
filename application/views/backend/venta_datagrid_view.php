...
<div class="container">
	<nav class="navbar navbar-default" role="navigation">
		<p class="navbar-text">Costos de Venta</p>
	...
	<?php
		if($datagrid_venta != null){
			...
			if($datagrid_subcuenta != null){
				...
				foreach ($datagrid_subcuenta as $key => $row2){
					$this->table->add_row(
						...
						"<a href=".base_url()."subcuenta/eliminar/".$row2->puc_id." onclick='if(confirma() == false) return false' id='eliminar".$key."'><span class='glyphicon glyphicon-remove'></span></a>"	
					);
