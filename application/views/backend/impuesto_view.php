	<body>
		...
		<nav class="navbar navbar-default" role="navigation">
			<p class="navbar-text">Nuevo Impuesto</p>
		</nav>
		<div class="row">
			<div class="col-md-5 col-lg-5">		
		<form role="form" id="form" name="form" action="<?=base_url()?>impuesto/guardar" method="POST">
		
				<div class="form-group">
				<?php echo form_error('impuesto_nombre'); ?>
					<label for="nombreimpuesto">Nombre :</label>	
						<input type="text" class="form-control" name="impuesto_nombre" id="impuesto_nombre" value="<?php echo set_value('impuesto_nombre'); ?>">
				</div>
				
			<div class="form-group">
			<?php echo form_error('impuesto_porcentaje');?>
				<label for="porcentajeimpuesto">Porcentaje :</label>
					<input type="text" class="form-control" name="impuesto_porcentaje" id="impuesto_porcentaje" value="<?php echo set_value('impuesto_porcentaje'); ?>">
			</div>
				
			<div class="form-group">
				<label for="tipoimpuesto">Tipo :</label>
					<input type="text" class="form-control" name="impuesto_tipo" id="impuesto_tipo" value="<?php echo set_value('impuesto_tipo');?>">
			</div>
