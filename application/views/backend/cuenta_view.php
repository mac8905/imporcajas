...
<div class="container">
	<nav class="navbar navbar-default" role="navigation">
		<p class="navbar-text">Nueva Cuenta</p>
	</nav>
	<form class="form" role="form" id="form" name="form" action="<?=base_url()?>cuenta/guardar" method="POST">
		...
		<div class="row">
			<div class="col-md-6 col-lg-6">
				<div class="form-group">
					...
					<input type="text" class="form-control input-sm" name="cuenta_numero" id="cuenta_numero" value="<?php echo set_value('cuenta_numero'); ?>">	
				</div>
				
				<div class="form-group">
					<?php echo form_error('cuenta_nombre'); ?>
					<label for="nombrecuenta">Nombre de la cuenta</label>
					<input type="text" class="form-control input-sm" name="cuenta_nombre" id="cuenta_nombre" value="<?php echo set_value('cuenta_nombre'); ?>">
				</div>
