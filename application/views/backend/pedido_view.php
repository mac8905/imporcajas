...
<div class="container-fluid">
	...
	<form class="form-group" role="form" id="form" name="form" action="<?=base_url()?>pedido/guardar" method="POST">
		...
		<div class="row" id="fila_productos1"><!--Inicio de la segunda fila-->
			...
			<div class="form-group">
				<label for="pedido" class="col-md-0 col-lg-0 control-label">Producto</label>
				<div class="col-md-0 col-lg-0">
					<select class="form-control input-sm" name="pedido_producto[]" id="1">
			...
			<div class="col-md-2 col-lg-2">
			<div class="form-group">
				<label for="pedido_tamano" class="col-md-0 col-lg-0 control-label">Tamaño</label>
				<div class="col-md-12 col-lg-12">
					<div class="row">
						<input type="text" class="form-control input-sm" name="pedido_tamano[]" id="pedido_tamano1" placeholder="alto-ancho-largo" title="alto-ancho-largo">
					</div>
				</div>
			</div>
			</div>
			...
			<div class="col-md-2 col-lg-2">
			<div class="form-group">
				<label for="pedido_precio" class="col-md-0 col-lg-0 control-label">Precio</label>
				<div class="col-md-12 col-lg-12">
					<div class="row">
						<div id="pedido_preciov">
							<input type='text' class='form-control input-sm' name='pedido_precio[]' id="pedido_precio1" onkeyup="total(1)">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<label for="pedidodescuento" class="col-md-0 col-lg-0 control-label">Desc%</label>
				<div class="col-md-12 col-lg-12">
					<div class="row">
						<input type="text" class="form-control input-sm" name="pedido_descuento[]" id="pedido_descuento1" onkeyup="total(1)" value="0">
					</div>
				</div>
			</div>
			</div>
			...
			<div class="col-md-2 col-lg-2">
			<div class="form-group">
				<label for="pedidoimpuesto" class="col-md-0 col-lg-0 control-label">Impuesto</label>
				<div class="col-md-12 col-lg-12">
					<div class="row">
						<select class="form-control input-sm" name="pedido_impuesto[]" id="pedido_impuesto1" onchange="fn_impuesto(1)">
						<?php
			...
			<div class="col-md-1 col-lg-1">
			<div class="form-group">
				<label for="pedidocantidad" class="col-md-0 col-lg-0 control-label">Cantidad</label>
				<div class="col-md-12 col-lg-12">
					<div class="row">
						<input type="text" class="pedido_cantidad1 form-control input-sm" name="pedido_cantidad[]" id="pedido_cantidad1" onkeyup="total(1)">
					</div>
				</div>
			</div>
			</div>		
			<div class="col-md-1 col-lg-1">
			<div class="form-group">
				<label for="pedidototal" class="col-md-0 col-lg-0 control-label">Total</label>
				<div class="col-md-12 col-lg-12" >
					<div class="row" id="pedido_total1">0</div>
				</div>
			</div>
			</div>
			<div class="col-md-0 col-lg-0">
