...
<div class="container">
	<nav class="navbar navbar-default" role="navigation">
		<p class="navbar-text">Nuevo Grupo</p>
	</nav>
	<form class="form" role="form" id="form" name="form" action="<?=base_url()?>grupos/guardar" method="POST">
		...
		<div class="row">
			<div class="col-md-6 col-lg-6">
				<div class="form-group">
					...
					<input type="text" class="form-control input-sm" name="grupo_numero" id="grupo_numero" value="<?php echo set_value('grupo_numero'); ?>">	
				</div>
				
				<div class="form-group">
					<?php echo form_error('grupo_nombre'); ?>
					<label for="nombregrupo">Nombre del grupo</label>
					<input type="text" class="form-control input-sm" name="grupo_nombre" id="grupo_nombre" value="<?php echo set_value('grupo_nombre'); ?>">
				</div>
