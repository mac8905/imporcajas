...
<!-- En esta vista realizamos el formulario del cliente y proveedor -->
	...
	<div class="container">
			...
			<nav class="navbar navbar-default" role="navigation">
				<p class="navbar-text">Nuevo Cliente</p>
			</nav>

					<!-- Enviamos los datos del formulario al controlador cliente y a la funcion guardar -->
					<form class="form-horizontal" role="form" id="form" name="form" action="<?=base_url()?>cliente/guardar" method="POST">
						<div class="row">
			<div class="col-md-6">
						...
						<div class="form-group">
							<?php echo form_error('relacion_nit'); ?>
							<label for="nit" class="col-lg-3 control-label">Nit :</label>
							<div class="col-lg-6">
								<input type="text" class="form-control" name="relacion_nit" id="nit" value="<?php echo set_value('relacion_nit');?>">
							</div>
						</div>
						...
						<div class="form-group">
							<?php echo form_error('relacion_ciudad'); ?>
			...
			<div class="col-md-6">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
							<div class="col-lg-offset-3 col-lg-1">
							  <div class="checkbox">
								<label class="checkbox-inline">
								  <input type="checkbox" id="opciones_1" name="relacion_perfil_cliente" value="1" value="<?php echo set_checkbox('relacion_perfil_cliente','1');?>"> 
								  Cliente
								</label>
							  </div>
							</div>
							...
							<div class="col-lg-offset-2 col-lg-1">
							  <div class="checkbox">
								<label class="checkbox-inline">
								  <input type="checkbox" id="opciones_2" name="relacion_perfil_proveedor" value="2" value="<?php echo set_checkbox('relacion_perfil_proveedor','2');?>"> 
								  Proveedor
								</label>
							  </div>
							</div>
						...
						<div class="form-group">
							<div class="col-lg-offset-5 col-lg-1">
								<a class="btn btn-default" href="<?=base_url()?>cliente/datagrid">Cancelar</a>
								<input class="btn btn-default" type="submit" name="guardar" id="guardar" value="Guardar" title="Guardar Cliente">
							</div>
						</div>
