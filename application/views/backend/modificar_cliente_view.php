			<nav class="navbar navbar-default">
				<p class="navbar-text">Modificar Cliente</p>
			</nav>

				<!-- Enviamos los datos del formulario al controlador cliente y a la funcion guardar -->
				<form class="form-horizontal" role="form" id="form" name="form" action="<?=base_url()?>cliente/modificarEnlace/<?=$relacion_id?>" method="POST">
					<div class="row">
		<div class="col-md-6">
		...
		<div class="col-md-6">
					...
					<div class="form-group">
						<div class="col-lg-offset-3 col-lg-6">
							...
							<input class="btn btn-default" type="submit" name="modificar" id="modificar" value="Guardar cambios" title="Guardar Cliente">
						</div>
					</div>
