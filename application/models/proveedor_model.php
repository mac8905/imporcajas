...
class Proveedor_model extends CI_Model {
	...
	public function getCantidad () {
		return count($this->consultarProveedores());
	}
	...
	public function guardar_perfil($id, $perfiles) {
		if (isset($id) && $perfiles != FALSE) {
			$query = $this->consultarProveedor($id);
	...
	public function modificarProveedor($id, $proveedor) {
		if (isset($id) && $proveedor != FALSE) {
			$this->db->where('relacion_id', $id);
			$this->db->update('Relacion', $proveedor);
		}
	}
